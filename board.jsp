<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" %>
<%@ page import="board_create.Topic, java.util.List" %>
	...
	<div class="main-wraper">
		...
		<div class="main-content">
			<div class="content-child">
				...
				<!-- 記事登録用のフォーム -->
				<form name="insertForm" method="post" action="post">
				...
				<div class="child-table">
					...
					%>
					<form class="delete_form" name="deleteForm" method="post" action="delete">
